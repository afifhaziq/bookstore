...
function BarXAxisLabel({
  ...
  return (
    <div
      className="absolute"
      style={{ left: x, bottom: 4, width: 0, display: "flex", justifyContent: "center" }}
    >
      <motion.span
        animate={{ opacity }}
        className={cn("absolute origin-top-right whitespace-nowrap text-chart-label text-xs")}
        initial={{ opacity: 1 }}
        style={{ transform: "rotate(-40deg) translateX(-50%)" }}
